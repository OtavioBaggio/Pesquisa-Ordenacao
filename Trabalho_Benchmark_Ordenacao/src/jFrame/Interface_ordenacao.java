 ...
 * <ul>
 *   <li>Carregue números de um arquivo.</li>
 *   <li>Escolha métodos de ordenação (Bolha, Seleção, Inserção, Shake, Pente, Shell, QuickSort).</li>
 *   <li>Execute os métodos selecionados e visualize os resultados, incluindo comparações, trocas e tempo de execução.</li>
 * </ul>
 * <p>
...
public class Interface_ordenacao extends javax.swing.JFrame {
     ...
     * 
     * @param nome - do método de ordenação (ex.: "Bolha", "QuickSort").
     * @param lista - de inteiros a ser ordenada.
     * @return - Uma string formatada contendo:
     * <ul>
     *           <li>Método utilizado</li>
     *           <li>Número de comparações</li>
     *           <li>Número de trocas</li>
     *           <li>Tempo de execução em nanossegundos</li>
    ...
    * <p>
    * Este método verifica se há números carregados e se pelo menos
    * um algoritmo de ordenação foi selecionado. Caso contrário,
    * exibe mensagens de aviso.
    * </p>
    *
    * <p>
    * Para cada algoritmo de ordenação selecionado (Bolha, Seleção,
    * Inserção, Shake, Pente, Shell ou QuickSort), uma nova
    * {@link Thread} é criada e iniciada. Cada thread executa o
    * método {@code executarMetodo}, passando uma cópia da lista
    * original de números.
    * </p>
    *
    * <p>
    * O resultado de cada execução é adicionado ao componente
    * {@code txtA_ordenados} de forma assíncrona, utilizando
