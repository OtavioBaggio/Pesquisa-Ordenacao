...
#Agitacao:
tempoInicio = time.time()
qtd_comparacoes, qtd_trocas = ord.insercao(lista_agitacao)
tempoFim = time.time()
...
# Pente:
tempoInicio = time.time()
qtd_comparacoes, qtd_trocas = ord.insercao(lista_pente)
tempoFim = time.time()
...
#Shell:
tempoInicio = time.time()
qtd_comparacoes, qtd_trocas = ord.insercao(lista_shell)
tempoFim = time.time()
